...
var BuiltinConditionTemplates = []InspectionConditionTemplate{
	{
		...
		Name:             "Java 内存溢出 (OOM)",
		Description:      "exception_class 含 OutOfMemoryError 时立即触发巡检。",
	...
	},
	{
		...
		Category:         ConditionCategoryJavaError,
		Name:             "Java 栈溢出",
		Description:      "exception_class 含 StackOverflowError 时立即触发巡检。",
		ImmediateOnMatch: true,
	},
	{
		...
		Category:         ConditionCategoryJavaError,
		Name:             "Metaspace 耗尽",
		Description:      "exception_class 含 OutOfMemoryError 且 message 含 Metaspace 时立即触发巡检。",
		ImmediateOnMatch: true,
	},
	{
		...
		Name:                 "GC 频繁",
		Description:          "jvm_gc_pause_seconds_count rate 5m 超过阈值次/分钟，持续 N 分钟。",
		DefaultThreshold:     10,
	...
	},
	{
		...
		Category:             ConditionCategoryPrometheus,
		Name:                 "堆内存持续上涨",
		Description:          "jvm_memory_used_bytes{area=\"heap\"} 连续 N 分钟单调递增。",
	...
	},
	{
		...
		Category:             ConditionCategoryPrometheus,
		Name:                 "堆内存使用率高",
		Description:          "heap used/max 超过 N% 持续 M 分钟。",
		DefaultThreshold:     85,
	...
	},
	{
		...
		Category:             ConditionCategoryPrometheus,
		Name:                 "CPU 持续高负载",
		Description:          "process_cpu_usage 超过 N% 持续 M 分钟。",
		DefaultThreshold:     90,
		DefaultWindowMinutes: 10,
	},
	{
